...
import { Mailbox, MessageCircle, MessageCircleDashed, MessageSquare, Phone, SendHorizontal, User } from 'lucide-react';
            ...
            <div className={contactStyles.form}> 
              ...
              >
                  ...
                  <div className={contactStyles.formGroup}>
                    ...
                    <input 
                      ...
                      className={`
                        ...
                        ${contactStyles.colors.purple.hover}
                      `}
                  ...
                  <div className={contactStyles.formGroup}>
                    ...
                    <input 
                      ...
                      className={`
                        ...
                        ${contactStyles.colors.blue.hover}
                      `}
                ...
                <div className={contactStyles.formGroup}>
                  ...
                  />
                  {phoneError && <p className={contactStyles.errorText}>{phoneError}</p>}
                </div>
