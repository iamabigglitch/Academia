...
const AdminListPage = () => {
  ...
  // Robust fetch that handles variations
    ...
    return (
      <div className={listStyles.starRating}>
        {Array.from({ length: fullStars }).map((_, i) => (
          <Star key={`full-${i}`} className={listStyles.starFull} fill="currentColor" />
        ))}
        {hasHalf && (
          <div className="relative inline-block" key="half">
            <Star className={listStyles.starEmpty} />
            <div className="absolute inset-0 overflow-hidden w-1/2">
              <Star className={listStyles.starFull} fill="currentColor" />
            </div>
          </div>
        )}
                      ...
                      <div className={listStyles.actionButtons}>
                        ...
                        >
                          {expandedCourse === course.id ? (
                            ...
                            <EyeOff className={listStyles.actionIcon} />
                          )}
                        </button>
