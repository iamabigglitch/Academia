...
// //this is a helper function too and it normalize lecture/chapter total
...
//     },
//   };
// }; //this function will calculate total time and oveeride the manual input given by the user  
...
//   //to calculate total minutes, dueation + total no of lectures
...
//     }
//     return true;
//   }; //if filled then ok else it will show an error toast 
...
//   }; //similarly to lectures first validate the input fields then if ok create a lecture a chapter

  
//   //add a chapter, remove the lecture or remove a chapter funtions
...
//                 Craft an exceptional learning experience with our intutive Course Creation Platform.   
//                 </p>
//             </div>
...
//                         <div className={addPageStyles.durationGrid}>
//                             <div>
//                                 <input type="number" name= "duration.hours" value={currentLecture.duration.hours}
//                                 onChange={handleLectureChange} placeholder="Hours" min='0' className={addPageStyles.input} />
...
//                             </div>
//                             <div>
//                             <input type="number" name= "duration.minutes" value={currentLecture.duration.minutes}
//                                 onChange={handleLectureChange} placeholder="Minutes" min="0" max="59" className={addPageStyles.input} />
...
//                     <div>
//                         <label className={addPageStyles.inputLabel}>
//                             Chapter in this lecture:
//                         </label>
//                         <div className={addPageStyles.chaptersList}>
//                             {currentLecture.chapters.map(chapter) => (
//                                 <div key={charper.id} className={addPageStyles.chapterPreview}>
